            ...
            <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }}
                ...
                <div className="bg-white/[0.04] backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/30 text-sm mt-2">Join the GYMJERKSS family</p>
                    </div>
                    ...
                    <p className="text-center text-sm text-white/30 mt-6">
                        Already have an account? <Link to="/login" className="text-[#39ff14] font-semibold hover:underline">Sign in</Link>
                    </p>
                </div>
            </motion.div>
        </div>
