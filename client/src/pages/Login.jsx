            ...
            <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }}
                ...
                <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400 text-sm mt-2">Welcome back, lifter</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input required type={showPwd ? 'text' : 'password'} value={form.password} onChange={e => setForm({ ...form, password: e.target.value })}
                                    placeholder="Enter password" className="input-field rounded-xl pr-10" />
                    ...
                    <p className="text-center text-sm text-gray-400 mt-6">
                        New here? <Link to="/register" className="text-accent font-semibold hover:text-accent-light">Create account</Link>
                    </p>
                </div>
            </motion.div>
        </div>
